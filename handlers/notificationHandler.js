...
exports.sendNewGroupCreated = (req, values) => {
  console.log("new group creating request: ", req);
  console.log("new group creating values: ", values);
};

exports.sendNewOrganizationCreated = (req, values) => {
  console.log("new Organization creating request: ", req);
  console.log("new Organization creating values: ", values);
};
